    ...
    void writeFiles(){
        ...
        FILE* cpufile;
        FILE* osfile;
        cpufile = fopen("/Users/jinayjain/Documents/Sem 5/CN Lab/cpu_stats.txt", "w");
        osfile = fopen("/Users/jinayjain/Documents/Sem 5/CN Lab/os_stats.txt", "w");
        ...
        //OS File write
        fprintf(osfile, x"System Name = %s\n", os_details.system);
